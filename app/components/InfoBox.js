...
function InfoBox({content, title, navigation, backScreen, slug}) {
            ...
            {typeof content !== 'undefined' && content !== null ?
                <View style={tw`px-1`}>
                    ...
                    <View style={tw`flex items-center content-center mt-3`}>
                        <TouchableOpacity
                            onPress={() => navigation.navigate('ModalOverlay', {content: <InfoModalContent title={title} content={content} navigation={navigation} backScreen={backScreen} routeParams={{slug: slug}}/>})}
