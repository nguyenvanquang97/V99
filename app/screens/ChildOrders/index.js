...
import OrderList from "app/screens/ChildOrders/OrderList";
...
function ChildOrderScreen(props) {
	...
	const renderScene = ({ route }) => {
		switch (route.key) {
			...
			case '2':
				return isFocused && <OrderList status={'Chờ xác nhận'} navigation={props.navigation} isFocused={isFocused} refresh={refresh}/>;
			case '3':
	...
	const renderTabBar = props => (
		<TabBar
			...
			style={{ backgroundColor: 'white' }} tabStyle={{width: 110}}
...
export default ChildOrderScreen;
