...
function WaitingWalletScreen(props) {
			...
			<View style={tw`bg-orange-500 px-3 pt-12 pb-3`}>
				...
				<View style={tw`bg-orange-500 pb-2`}>
					<View style={tw`flex items-center`}>
						<Text  style={tw`text-white mb-3 font-medium text-lg`}>Ví chờ</Text>
						<Text  style={tw`text-white text-xs mb-1`}>Số dư ví</Text>
						<Text  style={tw`text-white font-bold text-4xl`}>{currentUser && formatVND(currentUser.waitingWallet)}</Text>
					</View>
				</View>
			</View>
			<ScrollView
...
export default WaitingWalletScreen;
