...
function TransferHistoryScreen(props) {
	console.log(props);
	...
	useEffect(() => {
		if (isFocused) {
			async function getPackageInfo() {
				...
				axios({
					method: 'get',
					url: `${apiConfig.BASE_URL}/member/transactions/transferhistory`,
					params: {
	...
	return (
		<View>
			<View style={tw`bg-white ios:pt-4 android:pt-4 pb-4 flex-row items-center`}>
				...
				<Text style={tw`font-medium uppercase`}>Lịch sử chuyển nhận tiền</Text>
			</View>
			<ScrollView
