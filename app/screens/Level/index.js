...
function AccountLevelScreen(props) {
	...
	return (
		...
		<View style={tw`flex bg-white min-h-full content-between`}>
			<View style={tw`bg-blue-600 px-3 pt-12 pb-3`}>
				...
				<View style={tw`bg-blue-600 pb-2`}>
				...
				<View style={tw`pb-64 my-5 mx-3`}>
					<View style={tw`mb-5 bg-blue-50 p-3 border border-blue-300`}>
						{(Number(currentUser.sales) < Number(settings && settings.upgrade_to_agency_level3_value)) && (Number(currentUser.sales) >= Number(settings && settings.upgrade_to_agency_level2_value))
							&&
							<View>
								<Text>Bạn cần <Text  style={tw`font-medium text-red-600`}>{formatVND(Number(settings && settings.upgrade_to_agency_level3_value) - Number(currentUser.sales))}</Text> nữa để lên cấp <Text style={tw`font-bold text-blue-500`}>Đại lý cấp 3</Text></Text>
						...
						{(Number(currentUser.sales) < Number(settings && settings.upgrade_to_agency_level2_value)) && (Number(currentUser.sales) >= Number(settings && settings.upgrade_to_agency_level1_value))
							&&
							<View>
								<Text>Bạn cần <Text  style={tw`font-medium text-red-600`}>{formatVND(Number(settings && settings.upgrade_to_agency_level2_value) - Number(currentUser.sales))}</Text> nữa để lên cấp <Text style={tw`font-bold text-blue-500`}>Đại lý cấp 2</Text></Text>
						...
						{(Number(currentUser.sales) < Number(settings && settings.upgrade_to_agency_level1_value)) && (Number(currentUser.sales) >= Number(settings && settings.upgrade_to_agency_value))
							&&
							<View>
								<Text>Bạn cần <Text  style={tw`font-medium text-red-600`}>{formatVND(Number(settings && settings.upgrade_to_agency_level1_value) - Number(currentUser.sales))}</Text> nữa để lên cấp <Text style={tw`font-bold text-blue-500`}>Đại lý cấp 1</Text></Text>
						...
						{(Number(currentUser.sales) < Number(settings && settings.upgrade_to_agency_value))
							&&
							<View>
								<Text>Bạn cần <Text  style={tw`font-medium text-red-600`}>{formatVND(Number(settings && settings.upgrade_to_agency_value) - Number(currentUser.sales))}</Text> nữa để lên cấp <Text style={tw`font-bold text-blue-500`}>Đại lý</Text></Text>
					...
					<View style={tw`mb-5`}>
						<View style={tw`mb-3 flex flex-row items-center`}>
							<Icon name={"chart-box-outline"} size={18} style={tw`mr-2 text-blue-500`}/>
							<Text  style={tw`font-bold text-blue-500`}>Chính sách lên cấp</Text>
						</View>
						<View>
					...
					<View style={tw`mb-5`}>
						...
						<View>
							<View style={tw`pb-3 mb-3 border-b border-gray-200`}>
								<Text  style={tw`font-bold`}>Đại lý: <Text style={tw`font-normal`}>Chiết khấu trực tiếp <Text style={tw`font-bold text-blue-500`}>{settings && settings.agency_order_value_gt_percent}%</Text></Text></Text>
							</View>
							<View style={tw`pb-3 mb-3 border-b border-gray-200`}>
								<Text  style={tw`font-bold`}>Đại lý cấp 1: <Text style={tw`font-normal`}>Chiết khấu trực tiếp <Text style={tw`font-bold text-blue-500`}>{settings && settings.agency_discount_level1}%</Text> + thưởng <Text style={tw`font-bold text-red-600`}>{settings && settings.reward_agency_level1}%</Text> vào ví mua hàng</Text></Text>
							</View>
							<View style={tw`pb-3 mb-3 border-b border-gray-200`}>
								<Text  style={tw`font-bold`}>Đại lý cấp 2: <Text style={tw`font-normal`}>Chiết khấu trực tiếp <Text style={tw`font-bold text-blue-500`}>{settings && settings.agency_discount_level2}%</Text> + thưởng <Text style={tw`font-bold text-red-600`}>{settings && settings.reward_agency_level2}%</Text> vào ví mua hàng</Text></Text>
							</View>
							<View style={tw`pb-3 mb-3 border-b border-gray-200`}>
								<Text  style={tw`font-bold`}>Đại lý cấp 3: <Text style={tw`font-normal`}>Chiết khấu trực tiếp <Text style={tw`font-bold text-blue-500`}>{settings && settings.agency_discount_level3}%</Text> + thưởng <Text style={tw`font-bold text-red-600`}>{settings && settings.reward_agency_level3}%</Text> vào ví mua hàng</Text></Text>
							</View>
						</View>
					</View>
				</View>
